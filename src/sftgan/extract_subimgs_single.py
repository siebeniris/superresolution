...
from src.sftgan.utils.progress_bar import ProgressBar


def main():
    """A multi-thread tool to crop sub imags."""
    parser = argparse.ArgumentParser(description="Generate sub images from high resolution images...")
    parser.add_argument("--dataset", type=str, required=True, default="data/processed/tf_records",
                        help="val, test or train")
    args = parser.parse_args()

    input_folder = 'data/interim/datasets/' + args.dataset
    save_folder = 'data/processed/sftgan/' + args.dataset + '/sub'
